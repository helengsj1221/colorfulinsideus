	<head>
		...
		<link rel="stylesheet" href="css/mobile/menu-mobile.css" media="only screen and (min-width: 0px) and (max-width: 960px)" />
	</head> 
<div id="header">
<!-- 左上公司名 -->
<div id="logo">  <!-- 考慮放LOGO -->
...
<nav id="nav">
	<ul class="drop-down-menu">
		...
		<li><a class="link link-index" href="sign_up.php"><span data-letters-l="會員" data-letters-r="註冊">會員註冊</span></a></li>
