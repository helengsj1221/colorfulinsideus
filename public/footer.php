	<head>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
  		<link rel="stylesheet" href="css/pc/footer.css" />
		<link rel="stylesheet" href="css/mobile/footer-mobile.css" media="only screen and (min-width: 0px) and (max-width: 960px)" />
	</head> 
<!-- 頁尾 -->
<footer id="footer">
	<div class="footer-container">
	<h2><a href="contact.php">聯絡我們</a></h2><br><br>
<ul class="icon-list">
  ...
  <li class="icon-list__item">
	...
	<br><br><div>© Colorful Entertainment 2021</div>
</footer>